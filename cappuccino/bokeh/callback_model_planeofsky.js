...
var cos1, cos2, cos3, cos4, sin1, sin2, sin3, sin4, sinPhi, cosPhi;
var vy, vz;
var vr = 0;
var vphi = 0;
...
for (var index = 0; index < dynamics_index; index++) {
    ...
    sin4 = Math.sin(rand4[i] * Math.PI);
    cos4 = Math.cos(rand4[i] * Math.PI);
    ...
    [y[i],z[i]] = rotate(y[i], z[i], cos4, sin4);
